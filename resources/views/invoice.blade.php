...
@section('title', 'Fatura Oluştur')

@php($sidebar = 'faturaolustur')
        ...
        <div class="card">
            <form action="{{ route('fatura.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input id="musteriad" class="form-input" type="text" placeholder="Müşteri Ara" autocomplete="off">

                    <select class="form-select" name="customer_id" required>
                        <option value="">-- Müşteri Seçin --</option>
                        @foreach($musteriler as $musteri)
                            <option value="{{ $musteri->id }}">{{ $musteri->name." ".$musteri->surname }} ({{ $musteri->email }})</option>
                        @endforeach

                    </select>
                    <div class="customer-actions">
                        <a href="{{ route('musteri') }}?redirect=invoice" class="btn btn-sm btn-secondary">
                ...
                <div id="invoiceItems" class="invoice-items">
                    <div class="invoice-item">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" name="items[0][name]" placeholder="Ürün adı" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Miktar</label>
                            <input type="number" class="form-input" name="items[0][quantity]" value="1" min="1" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Birim Fiyat (₺)</label>
                            <input type="number" class="form-input" name="items[0][price]" step="0.01" placeholder="0.00" required>
                        </div>
                        <div class="form-group">
                ...
                <div class="tax-settings">
                    <div class="form-group" style="width: 150px;">
                        ...
                        <input type="number" id="taxRateInput" name="tax_rate" class="form-input" value="20" min="0" max="100">
                    </div>
                </div>
                ...
                <div class="form-group mt-4">
                    ...
                    <textarea class="form-textarea" name="notes" placeholder="Fatura üzerinde görünecek notlar..." rows="3"></textarea>
                </div>
